...
namespace Gymany.Models
{
    public class  ApplicationDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            .RuleFor(a => a.admin_username, f => f.Internet.UserName())
            .RuleFor(a => a.admin_password, f => f.Internet.Password())
            .RuleFor(a => a.admin_name, f => f.Name.FullName())
        ...
        modelBuilder.Entity<Admin>().HasData(adminFaker.Generate(10)); // Seed 10 Admin vào DB
